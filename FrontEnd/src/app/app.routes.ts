...
import { LiquidationCollectorsComponent } from './pages/liquidation-collectors/liquidation-collectors.component';
import { BenefitsCollectorsComponent } from './pages/benefits-collectors/benefits-collectors.component';
...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'benefit', component: BenefitsCollectorsComponent },
      { path: 'person-benefit', component: BenefitPersonRecolectorComponent },
      { path: 'liquidation-collectors', component: LiquidationCollectorsComponent },
      { path: 'account', component: AccountComponent },
